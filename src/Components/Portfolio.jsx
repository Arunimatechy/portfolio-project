...
//   description:
//     "Built a modern AI-powered productivity dashboard using React.js, Redux Toolkit, Tailwind CSS, and OpenRouter AI. Features include AI chat, Kanban task management, notes system, theme customization, search functionality, markdown rendering, and persistent local storage.",
...
const projects = [
...

  {
    ...
    image: SentimentAnalysis,
    description:
      "Built a Django-based AI sentiment analysis web application using Hugging Face models and Django REST Framework.",
    tech: [
      "Django",
      "Django REST Framework",
      "Hugging Face",
